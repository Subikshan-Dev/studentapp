    ...
    <ScrollView className="top-5">
      ...
      <View className="justify-center items-center">
        <View className="bg-innovat-bdgray4 w-[350] h-11 rounded-md flex flex-row justify-center items-center ">
          ...
          <TextInput
            ...
            placeholder="Search learners or Smart Goal"
            multiline
          />
        </View>
      </View>
      <View className="m-4">
        <Text className="text-lg text-innovat-blue">Plan List</Text>
      </View>
      <View className="border border-innovat-bdgray3 h-auto w-92 m-4 rounded-md">
        ...
        <View className="flex justify-center items-center">
          ...
          <Text className="text-innovat-bdgray text-sm m-2">
            smart Goal & progress measure
          </Text>
          <View className="m-2">
            <TextInput
              className="text-innovat-bdgray1 text-sm"
              value={text}
              onChangeText={handleTextChange}
              multiline
              numberOfLines={6}
